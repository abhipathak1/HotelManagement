...
public class RedisBookingService {
    ...
    public boolean cancelBooking(Long bookingId) {
        if (redisBookingRepository.existsById(bookingId.toString())) {
            redisBookingRepository.deleteById(bookingId.toString());
            return true;
        }
        return false;
    }
    ...
    public Booking getBookingDetails(Long bookingId) {
        return redisBookingRepository.findById(bookingId.toString()).orElse(null);
    }
}